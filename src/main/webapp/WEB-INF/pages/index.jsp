...
<!-- Timeline CSS -->
<link href="startbootstrap-sb-admin-2-1.0.5/dist/css/timeline.css"
	rel="stylesheet">
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header" style = "text-align: center"><strong><em>Dashboard</em></strong></h2>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
	...
	<script
		src="startbootstrap-sb-admin-2-1.0.5/bower_components/jquery/dist/jquery.js"></script>

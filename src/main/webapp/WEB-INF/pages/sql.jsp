...
function foo(){
    ...
    */
 	...
 	var objgetusername = jQuery.parseJSON(getusername);
 	//var details = jsonobj.Details;
 	//alert(objgetusername.RequestAttributes[0].name);
 	var method = obj.Method;
 	var typeofmethod = method.split(":");
      ...
      for(var i = 0; i < obj.RequestAttributes.length; i++ ){
        tabledata = "";
        tabledata += "<tr>";
        tabledata += "<td>" + objgetusername.RequestAttributes[i].name + "<br><small> Required field: "+ objgetusername.RequestAttributes[i].compulsory+"</small></td>";
        tabledata += "<td>" + objgetusername.RequestAttributes[i].dataType + "</td>";
        tabledata += "<td>" + objgetusername.RequestAttributes[i].description + "</td>";
        tabledata += "</tr>";
        $tbody.append(tabledata);
      }
      ...
      for(var j = 0; j < obj.ResponseAttributes.length; j++ ){
          tabledata1 = "";
          tabledata1 += "<tr>";
          tabledata1 += "<td>" + objgetusername.ResponseAttributes[j].name +"<br><small> Required field: "+ objgetusername.ResponseAttributes[j].compulsory+"</small></td>";
          tabledata1 += "<td>" + objgetusername.ResponseAttributes[j].dataType + "</td>";
          tabledata1 += "<td>" + objgetusername.ResponseAttributes[j].description + "</td>";
          tabledata1 += "</tr>";
          $tbody1.append(tabledata1);
        }
     ...
     GET Connection String
     */
      var getusername = '${getconnectionstring}';
   	var objgetusername = jQuery.parseJSON(getusername);
   	//var details = jsonobj.Details;
   //	alert(objgetusername.RequestAttributes[0].name);
   	var method = obj.Method;
